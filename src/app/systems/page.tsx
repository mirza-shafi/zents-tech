    ...
    <>
      ...
      <section className="border-b border-border">
        <div className="container-page space-y-6 py-16 md:py-20">
          ...
          {/* Diagnostics */}
          <Reveal delay={serviceCategories.length * 0.06}>
      ...
      <section>
        <div className="container-page py-16 md:py-20">
          <Reveal>
            ...
            <h2 className="mt-3 max-w-2xl text-balance font-display text-4xl font-extrabold tracking-tight md:text-5xl">
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-2">
            {productizedServices.map((svc, i) => (
              <Reveal key={svc.name} delay={(i % 2) * 0.08}>
                <Card>
                  <CardContent>
